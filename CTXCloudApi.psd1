...
@{
	...
	'Get-CTXAPI_LatestSessionAudit', 'Get-CTXAPI_LowLevelOperations', 
	...
	'Get-CTXAPI_Token', 'Get-CTXAPI_VDAUptime', 'Get-CTXAPI_Zones','Get-CTXAPI_MonitorData'
