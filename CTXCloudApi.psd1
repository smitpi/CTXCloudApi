...
FunctionsToExport = 'Add-CTXAPI_MachineToCatalog', 'Get-CTXAPI_Applications', 
               ...
               'Get-CTXAPI_Sessions', 'Get-CTXAPI_Siteid', 
               'Get-CTXAPI_StoreFrontServers', 'Get-CTXAPI_Token', 
               'Get-CTXAPI_VDAUptime', 'Get-CTXAPI_Zones', 'Set-CTXAPI_SecretStore', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'api','Citrix','cloud','ctx','xenapp','xendesktop'
        ...
        ReleaseNotes = 'Updated [24/04/2021_09:35] Added MS Secrect Store Functionality'
