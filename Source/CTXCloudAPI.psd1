...
FunctionsToExport = 'Add-CTXAPI_MachineToCatalog', 'Get-CTXAPI_Applications', 
               ...
               'Get-CTXAPI_Sessions', 'Get-CTXAPI_SiteDetails', 'Get-CTXAPI_SiteID', 
               'Get-CTXAPI_StoreFrontServers', 'Get-CTXAPI_Tests', 
               'Get-CTXAPI_Token', 'Get-CTXAPI_VDAUptime', 'Get-CTXAPI_Zones', 
               'Set-CTXAPI_SecretStore', 'Unlock-CTXAPI_CredentialFromSecretStore'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Updated [24/08/2021_10:17] Added CVAD Tests'
