...
HelpUri: https://smitpi.github.io/CTXCloudApi/Get-CTXAPI_Hypervisor
Locale: en-US
Module Name: CTXCloudApi
ms.date: 02/23/2026
PlatyPS schema version: 2024-05-01
title: Get-CTXAPI_Hypervisor
---
...
```
Get-CTXAPI_Hypervisor [-APIHeader] <CTXAPIHeaderObject> [<CommonParameters>]
```
