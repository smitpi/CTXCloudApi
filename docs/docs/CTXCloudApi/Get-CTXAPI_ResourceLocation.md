...
HelpUri: https://smitpi.github.io/CTXCloudApi/Get-CTXAPI_ResourceLocation
Locale: en-US
Module Name: CTXCloudApi
ms.date: 02/26/2026
PlatyPS schema version: 2024-05-01
title: Get-CTXAPI_ResourceLocation
---
...
```
Get-CTXAPI_ResourceLocation [-APIHeader] <CTXAPIHeaderObject> [<CommonParameters>]
```
