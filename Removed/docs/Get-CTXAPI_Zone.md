...
```
Get-CTXAPI_Zone [[-APIHeader] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://smitpi.github.io/CTXCloudApi/Get-CTXAPI_Zone](https://smitpi.github.io/CTXCloudApi/Get-CTXAPI_Zone)
