...
#
# Generated on: 2026-02-18 11:46:23Z
#
...
@{
    ...
    Description       = 'PowerShell module for Citrix Cloud CVAD Manage and Monitor OData APIs. Provides connect/auth (`Connect-CTXAPI`), inventory (Applications, Machines, Catalogs, Delivery Groups), monitoring data collection, and reporting with optional exports (Excel/HTML).'
